Rails.application.routes.draw do
  ...
  devise_scope :user do
    ...
    post "users/sign_up/address", to: "users/registrations#new_address"
    get "users/sign_up/credit_card", to: "users/registrations#new_credit_card"
    post "users/sign_up/credit_card", to: "users/registrations#new_credit_card"
    get "users/sign_up/phone_number", to: "users/registrations#new_phone_number"
    post "users/sign_up/phone_number", to: "users/registrations#new_phone_number"
  end
  root to: "homes#index"
